...
<p align="center">
  ...
  <a href="https://pkg.go.dev/github.com/0xbytejay/mediadevices"><img src="https://pkg.go.dev/badge/github.com/0xbytejay/mediadevices.svg" alt="Go Reference"></a>
...
```bash
go get -u github.com/0xbytejay/mediadevices
```
...
import (
	...
	_ "github.com/0xbytejay/mediadevices/pkg/driver/camera" 
...
import (
	"github.com/0xbytejay/mediadevices"
	"github.com/0xbytejay/mediadevices/pkg/codec/x264"      // This is required to use H264 video encoder
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/x264](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/x264)
* Installation:
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/mmal](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/mmal)
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/openh264](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/openh264)
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/vpx](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/vpx)
* Installation:
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/vaapi](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/vaapi)
* Installation:
...
* Package: [github.com/0xbytejay/mediadevices/pkg/codec/opus](https://pkg.go.dev/github.com/0xbytejay/mediadevices/pkg/codec/opus)
* Installation:
...
* Driver was not imported as a side effect in your program, e.g. `import _ github.com/0xbytejay/mediadevices/pkg/driver/camera`
...
* If trying to use `import _ github.com/0xbytejay/mediadevices/pkg/driver/screen` note that you will need to use `GetDisplayMedia` instead of `GetUserMedia` 
...
- **[pion/mediadevices](https://github.com/pion/mediadevices)**: Licensed under the MIT License. Copyright (c) [https://github.com/pion/mediadevices].
